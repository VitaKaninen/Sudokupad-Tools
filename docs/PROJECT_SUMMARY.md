...
- **Validate Constraints — the validator subsystem (v3.53+; full documentation in
  ...
  (Kropki, cages, little killers, thermos, German/Dutch whispers, XV, sum arrows, renban,
  region-sum, parity, zipper, entropic, modular) that remove — never add — centre candidates with no
