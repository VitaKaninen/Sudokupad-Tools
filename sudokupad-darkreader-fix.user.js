...
(function () {
  ...
  var DEFAULTS = {
    ...
    showDebugSection:             false,  // show debug panel in settings
  ...
  function buildSettingsUI() {
    ...
    // ── Debug section: hidden behind a toggle checkbox ────────────────────────
    ...
    var debugToggleRow = document.createElement('label');
    debugToggleRow.style.cssText = 'display:flex;align-items:center;gap:8px;cursor:pointer;font-size:11px;color:#6c7086;';
    var debugCb = document.createElement('input');
    debugCb.type = 'checkbox';
    debugCb.checked = !!settings.showDebugSection;
    Object.assign(debugCb.style, { cursor: 'pointer', accentColor: '#89b4fa', width: '13px', height: '13px', flexShrink: '0', margin: '0' });
    debugToggleRow.appendChild(debugCb);
    debugToggleRow.appendChild(document.createTextNode('Debug'));
    debugSection.appendChild(debugToggleRow);

    // Content — shown only when the checkbox is checked
    var debugContent = document.createElement('div');
    debugContent.style.display = settings.showDebugSection ? 'block' : 'none';
    Object.assign(debugContent.style, { marginTop: '8px' });
    ...
    debugContent.appendChild(dbgOutput);
    ...
    debugCb.addEventListener('change', function () {
      settings.showDebugSection = debugCb.checked;
      saveSettings(settings);
      debugContent.style.display = debugCb.checked ? 'block' : 'none';
    });
    controlSyncers['showDebugSection'] = function () {
      debugCb.checked = !!settings.showDebugSection;
      debugContent.style.display = settings.showDebugSection ? 'block' : 'none';
    };
